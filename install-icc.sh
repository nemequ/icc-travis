...
COMPONENTS_IFORT="intel-ifort-l-ps__x86_64;intel-ifort-l-ps-vars__noarch;intel-ifort-l-ps-common__noarch;intel-ifort-l-ps-devel__x86_64;${COMPONENTS_COMPILER_COMMON};${COMPONENTS_OPENMP}"
COMPONENTS_ICC="intel-icc-l-all__x86_64;intel-icc-l-ps-ss__x86_64;intel-icc-l-all-vars__noarch;intel-icc-l-all-common__noarch;intel-icc-l-ps-common__noarch;intel-icc-l-all-devel__x86_64;intel-icc-l-ps-devel__x86_64;intel-icc-l-ps-ss-devel__x86_64;${COMPONENTS_COMPILER_COMMON};${COMPONENTS_OPENMP}"

COMPONENTS_DEFAULT="${COMPONENTS_ICC};${COMPONENTS_IFORT};${COMPONENTS_DAAL};${COMPONENTS_IPP};${COMPONENTS_MKL};${COMPONENTS_TBB};${COMPONENTS_OPENMP};${COMPONENTS_MPI};${COMPONENTS_DEPS}"
